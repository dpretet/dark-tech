...
" Normal text.
let s:dtc.plain = ['f8f6f2', 15]

" Pure and simple.
let s:dtc.snow = ['ffffff', 15]
let s:dtc.coal = ['000000', 16]

" All of the Gravel colors are based on a brown from Clouds Midnight.
let s:dtc.brightgravel   = ['d9cec3', 252]
let s:dtc.lightgravel    = ['998f84', 245]
let s:dtc.gravel         = ['857f78', 243]
let s:dtc.mediumgravel   = ['666462', 241]
let s:dtc.deepgravel     = ['45413b', 238]
let s:dtc.deepergravel   = ['35322d', 236]
let s:dtc.darkgravel     = ['242321', 235]
let s:dtc.blackgravel    = ['1c1b1a', 233]
let s:dtc.blackestgravel = ['141413', 232]

" A color sampled from a highlight in a photo of a glass of Dale's Pale Ale on my desk.
let s:dtc.dalespale = ['fade3e', 221]

" A beautiful tan from Tomorrow Night.
let s:dtc.dirtyblonde = ['f4cf86', 222]

" Delicious, chewy red from Made of Code for the poppiest highlights.
let s:dtc.taffy = ['ff2c4b', 196]

" Another chewy accent, but use sparingly!
let s:dtc.saltwatertaffy = ['8cffba', 121]
...
" * The cursor
" * A REPL prompt
let s:dtc.tardis = ['0a9dff', 39]

" This one's from Mustang, not Florida!
let s:dtc.orange = ['ffa724', 214]

" A limier green from Getafe.
let s:dtc.lime = ['aeee00', 154]

" Rose's dress in The Idiot's Lantern.
let s:dtc.dress = ['ff9eb8', 211]

" Another play on the brown from Clouds Midnight.  I love that color.
let s:dtc.toffee = ['b88853', 137]

" Also based on that Clouds Midnight brown.
let s:dtc.coffee    = ['c7915b', 173]
let s:dtc.darkroast = ['88633f', 95]
...
if exists('g:darktech_darkgutter') && g:darktech_darkgutter
    let s:gutter = 'blackestgravel'
else
    let s:gutter = 'blackgravel'
endif

if exists('g:darktech_tabline')
    if g:darktech_tabline == 0
        let s:tabline = 'blackestgravel'
    elseif  g:darktech_tabline == 1
        let s:tabline = 'blackgravel'
    elseif  g:darktech_tabline == 2
        let s:tabline = 'darkgravel'
    elseif  g:darktech_tabline == 3
